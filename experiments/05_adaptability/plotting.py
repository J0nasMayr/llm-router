# experiments/05_adaptability/plotting.py
...
def main():
    ...
    exp_dirs = config_loader.setup_experiment_dirs("05_adaptability")

    # Load detailed results
    results_df = pd.read_csv(
        results_dir / f"05_adaptability_detailed_results_{timestamp}.csv"
    )
