...
def main():
    ...
    base_exp_dir = Path("experiments/X2_feature_ablation")
    ...
    detailed_results_file = results_dir / f"X2_feature_ablation_detailed_results_{timestamp}.csv"
    ...
    plot_title = "X2_feature_ablation (epsilon_greedy, λ=0.5)\nFinal Cumulative Regret Distribution"
