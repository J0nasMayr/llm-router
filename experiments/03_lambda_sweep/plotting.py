...
def main():
    ...
    exp_dirs = config_loader.setup_experiment_dirs("03_lambda_sweep")

    # Load required data files
    summary_df = pd.read_csv(
        results_dir / f"03_lambda_sweep_summary_stats_{timestamp}.csv"
    )
    run_means_df = pd.read_csv(
        results_dir / f"03_lambda_sweep_run_means_{timestamp}.csv"
    )
