...
def main():
    ...
    exp_dirs = config_loader.setup_experiment_dirs("01_algorithm_comparison")

    # Load required data files
    summary_df = pd.read_csv(
        results_dir / f"01_algorithm_comparison_summary_stats_{timestamp}.csv"
    )

    # For a5, detailed results is a single file without timestamp
    detailed_df = pd.read_csv(results_dir / "01_algorithm_comparison_detailed_results.csv")
